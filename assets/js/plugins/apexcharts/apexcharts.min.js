              ...
              value: function (t) {
                ...
                return (
                  ...
                  A.globals.dataChanged &&
                    P &&
                    T &&
                    C.animatePathsGradually(o(o({}, E), {}, { speed: u })),
                  I
                );
              }
            },
            ...
            value: function (t, e, i) {
              ...
              if (f.isNumber(n)) {
                if (null === t.x2 || void 0 === t.x2) {
                  ...
                  if (
                    (this.annoCtx.inversedReversedAxis &&
                      (d = (r - t.x2) / (o / a.globals.gridWidth)),
                    ("category" !== a.config.xaxis.type &&
                      !a.config.xaxis.convertedCatToNumeric) ||
                      this.invertAxis ||
                      a.globals.dataFormatXNumeric ||
              ...
              for (var h, c = [], d = 0, g = 0; g <= t.seriesIndex; g++) {
                ...
                if (u)
                  for (var p = g + 1; p <= t.seriesIndex; p++)
                    a.config.yaxis[p].seriesName === u &&
                      -1 === c.indexOf(u) &&
                      (d++, c.push(u));
              }
              if (a.config.yaxis[t.yAxisIndex].logarithmic) {
                h =
                  (n = new y(this.annoCtx.ctx).getLogVal(n, t.yAxisIndex)) /
                  a.globals.yLogRatio[t.yAxisIndex];
              } else {
                var x = t.yAxisIndex + d;
                h =
                  (n - a.globals.minYArr[x]) /
                  (a.globals.yRange[x] / a.globals.gridHeight);
              }
              if (
                ((r =
                ...
                a.config.yaxis[t.yAxisIndex] &&
                  ...
                  ((r = h + parseFloat(t.label.style.fontSize) + t.marker.size),
                  (o = h)),
                f.isNumber(s))
              ) {
                var b = {
            ...
            value: function (t, e) {
              ...
              return (
                  ...
                  }),
                {
                  ...
                  pointStrokeWidth: Array.isArray(o.strokeWidth)
                    ? o.strokeWidth[e]
                    : o.strokeWidth,
                  ...
                  shape:
                    s.pointShape ||
                    (Array.isArray(o.shape) ? o.shape[e] : o.shape),
                  class: t,
                  pointStrokeOpacity: Array.isArray(o.strokeOpacity)
                    ? o.strokeOpacity[e]
                    : o.strokeOpacity,
                  pointStrokeDashArray: Array.isArray(o.strokeDashArray)
                    ? o.strokeDashArray[e]
                    : o.strokeDashArray,
                  pointFillOpacity: Array.isArray(o.fillOpacity)
                    ? o.fillOpacity[e]
                    : o.fillOpacity,
                  seriesIndex: e
                }
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, o) {
              ...
              if (
                ("circle" === m.shape
                  ? (n = f.drawCircle(i))
                  : ("square" !== m.shape && "rect" !== m.shape) ||
                    (n = f.drawRect(
                      0,
                      0,
                      m.width - m.pointStrokeWidth / 2,
                      m.height - m.pointStrokeWidth / 2,
                      m.pRadius
                    )),
                l.config.series[h].data[r] &&
                  l.config.series[h].data[r].fillColor &&
                  (v = l.config.series[h].data[r].fillColor),
                n.attr({
              ...
              return (
                n.attr({ rel: r, j: r, index: s, "default-marker-size": a }),
                d.setSelectionFilter(n, s, r),
                u.addEvents(n),
            ...
            value: function (t) {
              ...
              if (
                ...
                f &&
                  ...
                  p.textRects &&
                    (a < -10 - p.textRects.width ||
                      a > e.globals.gridWidth + p.textRects.width + 10) &&
                    (n = "");
                ...
                ((("bar" === e.config.chart.type ||
                  ...
                  (m = e.globals.dataLabels.style.colors[o]),
                  "function" == typeof m &&
                    (m = m({
          ...
          },
          {
            ...
            value: function (t) {
              ...
              c.globals.previousPaths.length > 0 &&
                (p = this.barCtx.getPreviousPath(n, h, !1));
              var x = e,
                m = e + i,
                v = d.line(a, m - r);
              return (
                  ...
                  n.globals.seriesGoals[a][r].forEach(function (a) {
                    ...
                    l.push(
                      (s(
                        ...
                        t,
                        "x" === t
                          ? o.getXForValue(a.value, e, !1)
                          : o.getYForValue(a.value, i, !1)
                      ),
                      s(r, "attrs", a),
                      r)
                    );
                ...
                for (
                  ...
                  this.isHorizontal
                    ...
                    : ((M = this.drawColumnPaths(
                        o(o({}, z), {}, { xDivision: h, barWidth: A, zeroH: d })
                      )),
                ...
                void 0 !== t[e].data[o].y &&
                  (Array.isArray(t[e].data[o].y)
                    ? this.twoDSeries.push(
                        f.parseNumber(t[e].data[o].y[t[e].data[o].y.length - 1])
                      )
          ...
          },
          {
            ...
            value: function (t) {
              ...
              n.push(o.config.chart.toolbar.export.csv.headerCategory),
                ...
                o.globals.axisCharts ||
                  (n.push(o.config.chart.toolbar.export.csv.headerValue),
                  l.push(n.join(a))),
                i.map(function (t, e) {
                  o.globals.axisCharts
                    ? (function (t, e) {
                        if (
                          (n.length && 0 === e && l.push(n.join(a)),
            ...
            value: function (t) {
              ...
              for (var d = t; d < a; d++) {
                ...
                for (var g = 0; g < r.series[d].length; g++) {
                  var u = l[d][g];
                  null !== u && f.isNumber(u)
                    ? (void 0 !== c[d][g] && (o = Math.max(o, c[d][g])),
                      void 0 !== h[d][g] &&
                        ((e = Math.min(e, h[d][g])),
                        (i = Math.max(i, h[d][g]))),
              ...
              for (
                ...
                (C.background = s[l]),
                  ...
                  (C.left =
                    ...
                    "px"),
                  (C.top =
                    (Array.isArray(m) ? parseFloat(m[l]) : parseFloat(m)) +
                    "px"),
            ...
            value: function (t) {
              ...
              if ("heatmap" === e.config.chart.type || this.isBarsDistributed) {
                ...
                !t.target.classList.contains("apexcharts-inactive-legend") &&
                  i &&
                  new I(this.ctx).toggleSeriesOnHover(t, t.target);
            }
          },
          {
            key: "onLegendClick",
              ...
              if (void 0 !== t || void 0 !== e) {
                if (
                  ...
                  if (i.config.chart.zoom.autoScaleYaxis)
                    o = new j(this.ctx).autoScaleY(this.ctx, o, { xaxis: a });
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              d &&
                ...
                ((p = Math.ceil(g / l)), (p -= 1));
              for (
                var b, m = null, v = null, y = [], w = 0;
                w < r.globals.seriesXvalues.length;
                w++
              )
                y.push(
                  [r.globals.seriesXvalues[w][0] - 1e-6].concat(
                    r.globals.seriesXvalues[w]
                  )
                );
              return (
                (y = y.map(function (t) {
                ...
                r.globals.isXNumeric &&
                  ((m = (v = this.closestInMultiArray(g, u, y, b)).index),
                  (p = v.j),
                  null !== m &&
                    ((y = r.globals.seriesXvalues[m]),
                    (p = (v = this.closestInArray(g, y)).index))),
                (r.globals.capturedSeriesIndex = null === m ? -1 : m),
                (!p || p < 1) && (p = 0),
        ...
        a(t, [
              ...
              for (
                var m = function (t, r) {
                    ...
                    if (c.globals.axisCharts) {
                      ...
                      l
                        ? ((m = i.getFormatters(v)),
                          ...
                          (b = c.globals.colors[v]),
                          (e = y(v)),
                          g(v) &&
                            (d = c.globals.seriesGoals[v][s].map(function (t) {
                              return {
                                attrs: t,
                    ...
                    null === s &&
                      (e = m.yLbFormatter(
                        c.globals.series[a],
                        o(o({}, c), {}, { seriesIndex: a, dataPointIndex: a })
                      )),
                      i.DOMHandling({
                        i: a,
                        t: v,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              m && (m.innerHTML = void 0 !== c ? c : ""),
                x[0] &&
                  x[0].classList.contains("apexcharts-tooltip-marker") &&
                  (l.config.tooltip.marker.fillColors &&
                    Array.isArray(l.config.tooltip.marker.fillColors) &&
                    (n = l.config.tooltip.marker.fillColors[e]),
                  (x[0].style.backgroundColor = n)),
                l.config.tooltip.marker.show || (x[0].style.display = "none");
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              e.globals.isBarHorizontal &&
                (s =
                  new I(this.ctx).getActiveConfigSeriesIndex(!1, "desc") + 1);
              var r = e.globals.dom.baseEl.querySelector(
              ...
              if (
                ...
                if (
                  ...
                  (a = n.globals.clientX - f.left - o.tooltipRect.ttWidth / 2),
                    (s =
                      n.globals.clientY - f.top - o.tooltipRect.ttHeight - 5);
                }
              }
              return { x: a, y: s };
            }
            ...
            value: function (t, e, i, a, s) {
              ...
              if (o.config.legend.tooltipHoverFormatter) {
                ...
                for (var g = 0; g < d.length; g++) {
                  ...
                  if (r)
                    u.innerHTML =
                      o.globals.collapsedSeriesIndices.indexOf(f) < 0 ? x : p;
            ...
            value: function (t) {
              ...
              for (
                ...
                !this.initialAnim ||
                  e.globals.resized ||
                  e.globals.dataChanged ||
                  ((I = ((S - w) / 360) * e.config.chart.animations.speed),
            ...
            value: function (t) {
              ...
              if (0 === o) {
                ...
                l.globals.isXNumeric &&
                  ...
                  h.push(d),
                  c.push(
                    f.isNumber(e[r][0]) ? n + l.config.markers.offsetY : null
                  ),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (h.count > 0) {
                var c =
                    r.globals.seriesXvalues[i][
                      r.globals.seriesXvalues[i].length - h.count - 1
                    ],
                  d = n.drawRect(
                    c,
                    0,
              ...
              if ("area" === e)
                for (
                  var f = l.fillPath({ seriesNumber: i }), p = 0;
                ...
                for (var v = 0; v < s.linePaths.length; v++) {
                  ...
                  if ((this.elSeries.add(w), h.count > 0)) {
                    ...
                    k.node.setAttribute("stroke-dasharray", h.dashArray),
                      h.strokeWidth &&
                        k.node.setAttribute("stroke-width", h.strokeWidth),
                      this.elSeries.add(k),
                      k.attr(
                        "clip-path",
            ...
            value: function (t) {
              for (
                ...
                (c = I.areaPaths),
                  ...
                  this.handleNullDataPoints(e, z, a, P, i),
              ...
              if (
                ...
                f.globals.hasNullValues
                  ? (null !== e[i][s] &&
                    ...
                    d.push(h),
                    g.push(c))
                  : ((h += p.curve(n + v, l, r - v, o, r, o)),
                    (c += p.curve(n + v, l, r - v, o, r, o))),
                  (n = r),
                  (l = o),
                  s === e[i].length - 2 &&
                    ((c = c + p.curve(n, l, r, o, r, m) + p.move(r, o) + "z"),
                ...
                null === e[i][s] && ((h += p.move(r, o)), (c += p.move(r, m))),
                  "stepline" === x
                    ? ((h = h + p.line(r, null, "H") + p.line(null, o, "V")),
                      (c = c + p.line(r, null, "H") + p.line(null, o, "V")))
                    : "straight" === x &&
                      ((h += p.line(r, o)), (c += p.line(r, o))),
                  s === e[i].length - 2 &&
                    ((c = c + p.line(r, m) + p.move(r, o) + "z"),
                    d.push(h),
                    g.push(c));
              }
              return {
            ...
            t = (e = (function (t, e) {
              ...
              for (
                b[0][0] = b[0][1].clone(),
                  ...
                  s = new SVG.Matrix().rotate(z).scale(T, M).rotate(-z),
                  k = 0,
                  A = b.length;
                k < A;
                k++
        ...
        a(t, [
          {
            ...
            value: function () {
              (this.ctx.publicMethods = [
                ...
                (this.ctx.series = new I(this.ctx)),
